...
import { Pagination as PaginationPrimitive } from '@/components/ui/Pagination'
...
export default function PropertiesPage () {
  ...
  // Convertir les filtres string en number pour l'API
  ...
  const { properties, loading, error, pagination } =
    useProperties(processedFilters)
  ...
  const isAtViewLimit =
    !isAdmin && maxViewLimit && viewedProperties >= maxViewLimit
    ...
    <div className='container mx-auto py-8'>
      ...
      <div className='flex flex-col lg:flex-row gap-6'>
        ...
        <div className='lg:w-3/4'>
          {/* Barre de recherche */}
          <div className='mb-6'>
            <SearchBar onSearch={query => handleFilterChange('q', query)} />
          </div>
          ...
          {limitedProperties.length === 0 && !isAtViewLimit ? (
            ...
            <>
              ...
              {!isAdmin && isAtViewLimit && (
                <AccessRestriction action='browse-properties'>
                  <div className='text-center py-8'>
                    <p className='text-lg font-semibold mb-2'>
                      Limite de vues atteinte
                    </p>
                    <p className='text-gray-600'>
                      Créez un compte pour voir plus de propriétés
                    </p>
                  </div>
                </AccessRestriction>
              )}

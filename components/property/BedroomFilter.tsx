...
interface BedroomFilterProps {
  ...
  selectedBedrooms?: number | undefined
...
export function BedroomFilter({ 
  ...
  const currentValue = selectedBedrooms !== undefined ? selectedBedrooms : (value || undefined)
  const handleChange = onBedroomChange || onChange || (() => {})
  const options = [

...
import { Users, Plus, Edit, Trash2, Search, Crown, UserIcon, Star, Mail, Phone, Building, Calendar } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
          ...
          <DialogContent className="max-w-md">
            ...
            <UserForm formData={formData} setFormData={setFormData} onSubmit={handleCreateUser} isEdit={false} />
          </DialogContent>
        </Dialog>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-green-600">{stats.agent}</div>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-gray-600">{stats.guest}</div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-4 text-xs text-muted-foreground">
                        ...
                        {user.lastLoginAt && (
                          <div>Dernière connexion: {new Date(user.lastLoginAt).toLocaleDateString()}</div>
                        )}
                      </div>
                    </div>
                  </div>
      ...
      <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
        <DialogContent className="max-w-md">
          ...
          <UserForm formData={formData} setFormData={setFormData} onSubmit={handleUpdateUser} isEdit={true} />
        </DialogContent>
      </Dialog>
    </div>
  )

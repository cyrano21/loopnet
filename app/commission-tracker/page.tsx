...
export default function CommissionTrackerPage() {
  ...
  const currentData = commissionData[timeframe as keyof typeof commissionData] || defaultCommissionData
  const goalProgress = currentData.goal > 0 ? (currentData.earned / currentData.goal) * 100 : 0
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link href="/commission-tracker" className="text-blue-600 font-medium">
                  Commissions
                </Link>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Track your earnings, goals, and payment status</p>
          </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">${(currentData.earned || 0).toLocaleString()}</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">${(currentData.pending || 0).toLocaleString()}</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">${(currentData.projected || 0).toLocaleString()}</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-purple-600">${(currentData.goal || 0).toLocaleString()} goal</p>
                </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Badge className={goalProgress >= 100 ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}>
                ${(currentData.earned || 0).toLocaleString()} / ${(currentData.goal || 0).toLocaleString()}
              </Badge>
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span>
                  ${Math.max(0, (currentData.goal || 0) - (currentData.earned || 0)).toLocaleString()} remaining
                </span>
              </div>
              <Progress value={Math.min(100, goalProgress)} className="h-3" />
              {goalProgress >= 100 && (
                <p className="text-sm text-green-600 font-medium">🎉 Congratulations! You've exceeded your goal!</p>
              )}
            </div>
          </CardContent>
        </Card>
                    ...
                    <div key={transaction.id} className="border rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">{transaction.commissionRate}% rate</p>
                        </div>
                        <div>
                          <p className="font-medium text-gray-700">Closing Date</p>
                          <p>{new Date(transaction.closingDate).toLocaleDateString()}</p>
          ...
          <TabsContent value="achievements" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {achievements.map((achievement, index) => (
                <Card
                  key={index}
                  className={`border-2 ${achievement.earned ? "border-green-200 bg-green-50" : "border-gray-200"}`}
                >
                  <CardContent className="p-6">
                    ...
                    {achievement.earned && <Badge className="bg-green-100 text-green-800">✓ Achieved</Badge>}
                  </CardContent>
                </Card>
              ))}
            </div>
                ...
                <CardContent>
                  <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-500">Monthly performance over time</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                    ...
                    {[
                      ...
                      <div key={item.type} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-semibold w-20 text-right">${item.amount.toLocaleString()}</span>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <TabsContent value="tax-docs" className="space-y-6">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { year: "2024", type: "1099-MISC", status: "Available", date: "2024-01-31" },
                    { year: "2023", type: "1099-MISC", status: "Available", date: "2023-01-31" },
                    { year: "2023", type: "Commission Summary", status: "Available", date: "2023-12-31" },
                    { year: "2022", type: "1099-MISC", status: "Available", date: "2022-01-31" },
                  ].map((doc, index) => (

...
export default function CheckoutPage() {
  ...
  const monthlyPrice = billingCycle === "annual" ? Math.floor(selectedPlan.annualPrice / 12) : selectedPlan.monthlyPrice
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <Button type="submit" size="lg" className="w-full" disabled={isLoading}>
                  {isLoading ? "Processing..." : `Complete Purchase - $${price}`}
                </Button>
              </form>
            </div>
            ...
            <div className="lg:col-span-1">
              <Card className="sticky top-8">
                ...
                <CardContent className="space-y-4">
                  ...
                  {billingCycle === "annual" && (
                    <div className="text-center text-sm text-green-600 font-medium">You save ${savings} per year!</div>
                  )}

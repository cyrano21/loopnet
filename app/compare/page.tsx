        ...
        <div className='container mx-auto py-8'>
          <div className='text-center py-12'>
            ...
            <p className='text-gray-600 mb-6'>
              Aucune propriété sélectionnée pour la comparaison
            </p>
    ...
    <RoleGuard requiredRole='user'>
      <div className='container mx-auto py-8'>
        <div className='flex items-center justify-between mb-6'>
          <div>
            ...
            <p className='text-gray-600'>
              {comparisonList.length} propriété(s) en comparaison
            </p>
          </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8'>
          {comparisonList.map((property: Property) => (
              ...
              <CardContent className='space-y-4'>
                ...
                <div>
                  ...
                  <div className='text-sm text-gray-600'>
                    ${calculatePricePerSqFt(property.price, property.size || 1)}
                    /sq ft
                  </div>
                </div>
                ...
                <div className='flex items-start gap-2'>
                  ...
                  <div className='text-sm text-gray-600'>
                    <div>
                      {property.location?.address || 'Adresse non disponible'}
                    </div>
                    <div>
                      {property.location?.city || 'Ville'},{' '}
                      {property.location?.state || 'État'}
                    </div>
                  </div>
                </div>
                ...
                <div className='space-y-2'>
                  <div className='flex items-center justify-between text-sm'>
                    ...
                    <span className='font-medium flex items-center'>
                      ...
                      {property.size?.toLocaleString() || 'N/A'} sq ft
                    </span>
                  </div>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
              <div>
                ...
                <div className='font-semibold text-green-600'>
                  {formatPrice(
                    Math.min(...comparisonList.map((p: Property) => p.price))
                  )}
                </div>
              </div>
              <div>
                ...
                <div className='font-semibold text-red-600'>
                  {formatPrice(
                    Math.max(...comparisonList.map((p: Property) => p.price))
                  )}
                </div>
              </div>
              <div>
                ...
                <div className='font-semibold'>
                  {Math.round(
                    comparisonList.reduce(
                      (acc: number, p: Property) => acc + (p.size || 0),
                      0
              ...
              <div>
                ...
                <div className='font-semibold'>
                  ...
                  {Math.round(
                    comparisonList.reduce(
                      (acc: number, p: Property) =>
                        acc + p.price / (p.size || 1),
                      0
                    ) / comparisonList.length
                  )}
                </div>

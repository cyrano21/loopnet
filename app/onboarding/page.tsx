...
import { Building2, CheckCircle, ArrowRight, Users, Home, Plane, Zap, Target, TrendingUp } from "lucide-react"
...
export default function OnboardingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      name: "Professional",
      price: 99,
      features: ["50 propriétés", "IA intégrée", "Support prioritaire", "Analytics avancées"],
      recommended: true,
    },
    {
      id: "enterprise",
      name: "Enterprise",
      price: 299,
      features: ["Propriétés illimitées", "API complète", "Support dédié", "White-label"],
      recommended: false,
    },
  ]
                    ...
                    return (
                      <Card
                        ...
                        className={`cursor-pointer transition-colors ${
                          formData.agentType === type.value ? "border-blue-500 bg-blue-50" : ""
                        }`}
                        onClick={() => setFormData({ ...formData, agentType: type.value })}
                      >
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => {
                          if (checked) {
                            ...
                            setFormData({
                              ...formData,
                              clientTypes: formData.clientTypes.filter((t) => t !== type),
                            })
                          }
                        }}
                      />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      marketAreas: e.target.value.split(", ").filter((area) => area.trim() !== ""),
                    })
                  }
                  placeholder="Paris, Lyon, Marseille..."
                />
                <p className="text-sm text-gray-600 mt-1">Séparez les villes par des virgules</p>
              </div>
            </CardContent>
          </Card>
        )
        ...
        return (
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <Label className="text-base font-semibold">Automatisation</Label>
                <div className="space-y-3 mt-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <Label>Répondeur automatique</Label>
                      <p className="text-sm text-gray-600">Réponses automatiques aux nouvelles demandes</p>
                    </div>
                    <Checkbox
                      checked={formData.autoResponder}
                      onCheckedChange={(checked) => setFormData({ ...formData, autoResponder: checked })}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                      <Label>Scoring automatique des leads</Label>
                      <p className="text-sm text-gray-600">IA pour qualifier automatiquement les prospects</p>
                    </div>
                    <Checkbox
                      checked={formData.leadScoring}
                      onCheckedChange={(checked) => setFormData({ ...formData, leadScoring: checked })}
                    />
                  </div>
                </div>
              </div>
            ...
            <CardContent>
              ...
              <div className="mt-6 p-4 bg-green-50 rounded-lg">
                <div className="flex items-center gap-2 text-green-800">
                  ...
                  <span className="font-semibold">Essai gratuit de 14 jours</span>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-600">Votre compte agent est maintenant configuré et prêt à l'emploi.</p>
              </div>
                ...
                <Card className="border-green-200 bg-green-50">
                  <CardContent className="p-4">
                    ...
                    <ul className="text-sm text-gray-700 mt-2 space-y-1">
                      ...
                      <li>• Spécialisations: {formData.specialization.length}</li>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600 mb-4">Besoin d'aide ? Notre équipe support est disponible 24/7</p>

    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-6">
                <Link href="/data-import" className="text-blue-600 font-medium">
                  Import Externe
                </Link>
                <Link href="/property-management" className="text-gray-700 hover:text-blue-600">
                  Gestion
                </Link>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold">Import depuis les APIs Externes</h1>
            <p className="text-gray-600">Importez automatiquement des propriétés depuis les principales plateformes</p>
          </div>
          <div className="flex gap-4">
            <Button onClick={handleImport} disabled={selectedSources.length === 0 || importStatus === "importing"}>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mt-1">{importProgress}% terminé</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-700">
                    {importResults.imported} propriétés importées, {importResults.skipped} ignorées,{" "}
                    {importResults.errors} erreurs
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="mb-6 border-red-200 bg-red-50">
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-red-800">Erreur d'import</h3>
                  <p className="text-red-700">Une erreur s'est produite lors de l'import. Veuillez réessayer.</p>
                </div>
              </div>
            </CardContent>
          </Card>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{source.totalImported}</span>
                      </div>
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="autoPublish">Publication automatique (sinon en attente de validation)</Label>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h4 className="font-medium text-blue-900 mb-2">🚀 Fonctionnalité Pro</h4>
                  <p className="text-sm text-blue-800">
                    Planifiez des imports automatiques quotidiens, hebdomadaires ou mensuels.
                  </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm">L'historique apparaîtra ici après votre premier import</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>

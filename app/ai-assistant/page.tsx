...
import { Send, Bot, User, Sparkles, TrendingUp, Calculator, FileText, Building2 } from "lucide-react"
  ...
  const aiFeatures = [
    {
      ...
      description: "Generate compelling, professional property descriptions automatically",
      icon: FileText,
      color: "text-blue-600",
      example: "Create a description for a 15,000 sq ft office building in downtown SF",
    },
    {
      title: "Market Analysis",
      description: "Get AI-powered insights on market trends and property values",
      icon: TrendingUp,
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link href="/ai-assistant" className="text-blue-600 font-medium">
                  AI Assistant
                </Link>
          ...
          <Tabs defaultValue="chat" className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">Powered by advanced language models and real estate expertise</p>
              </div>
              <TabsList>
                ...
                {aiFeatures.map((feature, index) => (
                  <Card key={index} className="border-2 hover:border-blue-300 transition-colors">
                    <CardContent className="p-6">
                      ...
                      <Button className="w-full" onClick={() => handleFeatureExample(feature.example)}>
                        Try This Feature
                      </Button>
                    </CardContent>
                  </Card>
            ...
            <TabsContent value="tools" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-600 mb-4">Generate professional property descriptions using AI</p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-600 mb-4">Get AI-powered market insights and trends</p>
                    <Button className="w-full">Launch Tool</Button>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-600 mb-4">AI-powered property valuation and analysis</p>
                    <Button className="w-full">Launch Tool</Button>
                  </CardContent>
                </Card>
              </div>

        ...
        >
          <TabsList>
            <TabsTrigger value='featured'>
              À la Une ({featuredArticles.length})
            </TabsTrigger>
            <TabsTrigger value='recent'>
              Récentes ({recentArticles.length})
            </TabsTrigger>
                      ...
                      <div className='lg:w-1/2'>
                        <Image
                          src={
                            ...
                            '/placeholder.svg?height=400&width=600&query=news article'
                          }
                    ...
                    {featuredArticles.slice(1).map(article => (
                      ...
                      >
                        <Image
                          src={
                            article.image ||
                            '/placeholder.svg?height=200&width=400&query=news article'
                          }
                          alt={article.title}
                          width={400}
                          height={200}

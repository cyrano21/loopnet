...
interface Property {
  ...
  address: string
  price: number
  priceType: 'sale' | 'rent' | 'vacation'
  pricePerSqft: number
  sqft: number
  type: string
  category: 'commercial' | 'residential' | 'vacation'
...
export default function PropertyManagementPage () {
  const [properties, setProperties] = useState<Property[]>([
    ...
    },
    {
      ...
      images: ['/placeholder.svg?height=300&width=400'],
      description:
        'Superbe appartement 3 pièces dans le 8ème arrondissement...',
    ...
    },
    {
      ...
      images: ['/placeholder.svg?height=300&width=400'],
      description:
        'Villa de charme avec piscine privée, idéale pour vacances...',
  ...
  const filteredProperties = properties.filter((property: Property) => {
    ...
    if (
      ...
      return false
    if (filters.priceMin && property.price < Number.parseInt(filters.priceMin))
      return false
    if (filters.priceMax && property.price > Number.parseInt(filters.priceMax))
      return false
    return true
  })
  ...
  const handleAddProperty = () => {
    const property: Property = {
      ...
      pricePerSqft: newProperty.pricePerSqft || 0,
      virtualTour: null,
      documents: []
    }
                      ...
                      <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value: 'commercial' | 'residential' | 'vacation') =>
                              setNewProperty({
                                ...newProperty,
                                category: value,
                                type: ''
                      ...
                      <div className='grid grid-cols-3 gap-4'>
                        <div>
                          ...
                          >
                            ...
                            <SelectContent>
                              {(propertyTypes[newProperty.category] || []).map(
                                (type: string) => (
                              ...
                              <Checkbox
                                ...
                                onCheckedChange={(checked: boolean) => {
                                  if (checked) {
                                    ...
                                    setNewProperty({
                                      ...newProperty,
                                      features: newProperty.features.filter(
                                        f => f !== feature
                                      )
                                    })
                                  }
        ...
        <div className='container mx-auto px-4 py-6'>
          <div className='flex items-center justify-between mb-8'>
            <div>
              ...
              <p className='text-gray-600'>
                Gérez vos biens immobiliers : commercial, résidentiel et
                vacances
              </p>
            </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-6 gap-4'>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setFilters({ ...filters, priceType: value })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <CardContent className='p-4'>
                  ...
                  <div className='grid grid-cols-2 gap-2 text-sm text-gray-600 mb-3'>
                    ...
                    {property.pricePerSqft && (
                      <div>Prix/m²: {property.pricePerSqft}€</div>
                    )}
                    {property.availability && (
                      <div>Dispo: {property.availability}</div>
                    )}
                  </div>
                  ...
                  <div className='text-sm text-gray-500 border-t pt-2 mb-3'>

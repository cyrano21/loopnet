...
import { Camera, FileText, Share2, Download, Eye, Building2, Palette, Mail, BarChart3, Target, Zap } from "lucide-react"
...
export default function MarketingSuitePage() {
  ...
  const templates = {
    brochure: [
      { id: "modern", name: "Modern Professional", preview: "/placeholder.svg?height=200&width=150" },
      { id: "classic", name: "Classic Elegant", preview: "/placeholder.svg?height=200&width=150" },
      { id: "minimal", name: "Minimal Clean", preview: "/placeholder.svg?height=200&width=150" },
    ],
    flyer: [
      { id: "bold", name: "Bold Impact", preview: "/placeholder.svg?height=200&width=150" },
      { id: "corporate", name: "Corporate Style", preview: "/placeholder.svg?height=200&width=150" },
      { id: "creative", name: "Creative Design", preview: "/placeholder.svg?height=200&width=150" },
    ],
    social: [
      { id: "instagram", name: "Instagram Story", preview: "/placeholder.svg?height=200&width=150" },
      { id: "linkedin", name: "LinkedIn Post", preview: "/placeholder.svg?height=200&width=150" },
      { id: "facebook", name: "Facebook Ad", preview: "/placeholder.svg?height=200&width=150" },
    ],
  }
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link href="/marketing-suite" className="text-blue-600 font-medium">
                  Marketing Suite
                </Link>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Create professional marketing materials with AI assistance</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold">{campaignStats.totalDownloads}</p>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold">{campaignStats.clickThrough}</p>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold">{campaignStats.socialShares}</p>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold">{campaignStats.leadGenerated}</p>
                  ...
                  <Card key={material.id} className="hover:shadow-md transition-shadow">
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-gray-600">{material.property}</p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select value={selectedProperty} onValueChange={setSelectedProperty}>
                        ...
                        <SelectContent>
                          <SelectItem value="downtown-office">Downtown Office Complex</SelectItem>
                          <SelectItem value="retail-center">Retail Shopping Center</SelectItem>
                          <SelectItem value="industrial-warehouse">Industrial Warehouse</SelectItem>
                          <SelectItem value="medical-office">Medical Office Building</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                      ...
                      <div className="aspect-[3/4] bg-gray-100 rounded-lg flex items-center justify-center">
                        {selectedTemplate ? (
                          <div className="text-center">
                            ...
                            <p className="text-sm text-gray-500">{selectedTemplate} style</p>
                          </div>
                        ) : (
                          <div className="text-center">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        <label className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">AI-generated property description</span>
                        </label>
                        <label className="flex items-center space-x-2">
                          <input type="checkbox" className="rounded" defaultChecked />
                        ...
                        <label className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">Investment highlights</span>
                        </label>
                        <label className="flex items-center space-x-2">
                          <input type="checkbox" className="rounded" />
                          <span className="text-sm">Neighborhood information</span>
                        </label>
                      </div>
                    </div>
                  </div>
                    ...
                    <div key={index} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{campaign.property}</p>
                        </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      {
                        platform: "LinkedIn",
                        content: "🏢 New Listing: Premium office space in downtown...",
                        engagement: { likes: 45, shares: 12, comments: 8 },
                        posted: "2 hours ago",
                      },
                      {
                        platform: "Instagram",
                        content: "✨ Virtual tour of our stunning retail space...",
                        engagement: { likes: 89, shares: 23, comments: 15 },
                        posted: "1 day ago",
                      },
                      {
                        platform: "Facebook",
                        content: "📈 Market update: Commercial real estate trends...",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <CardContent>
                  <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-500">Campaign effectiveness over time</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { name: "Downtown Office Brochure", views: 234, downloads: 45, conversion: "19.2%" },
                      { name: "Retail Center Virtual Tour", views: 189, downloads: 23, conversion: "12.2%" },
                      { name: "Industrial Warehouse Flyer", views: 156, downloads: 18, conversion: "11.5%" },
                    ].map((material, index) => (
                      <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                        <div>
                          <h4 className="font-medium text-sm">{material.name}</h4>
                          <p className="text-xs text-gray-600">
                            {material.views} views • {material.downloads} downloads
                          </p>
                        </div>
                        <Badge className="bg-green-100 text-green-800">{material.conversion}</Badge>
                      </div>
                    ))}
                  </div>
                </CardContent>

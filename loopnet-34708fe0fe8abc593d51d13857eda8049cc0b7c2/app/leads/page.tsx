  ...
  const leads = [
    {
      ...
      notes: "Looking for 15,000 sq ft office space. Decision maker. Ready to move quickly.",
      avatar: "/placeholder.svg?height=40&width=40",
      activities: [
        { type: "email", date: "2 hours ago", description: "Sent property brochure" },
        { type: "call", date: "1 day ago", description: "Initial consultation call" },
        { type: "visit", date: "3 days ago", description: "Website visit - property page" },
      ],
    },
    {
      id: 2,
      ...
      avatar: "/placeholder.svg?height=40&width=40",
      activities: [
        { type: "meeting", date: "1 day ago", description: "Site visit scheduled" },
        { type: "email", date: "3 days ago", description: "Follow-up email sent" },
      ],
    },
    {
      id: 3,
      ...
      avatar: "/placeholder.svg?height=40&width=40",
      activities: [{ type: "email", date: "1 week ago", description: "Initial inquiry response" }],
    },
    {
      id: 4,
      name: "David Park",
      ...
      avatar: "/placeholder.svg?height=40&width=40",
      activities: [
        { type: "call", date: "3 hours ago", description: "Negotiation discussion" },
        { type: "meeting", date: "2 days ago", description: "Property tour completed" },
                ...
                <Card key={status}>
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                      ...
                      <Badge variant="outline">{leads.filter((l) => l.status === status).length}</Badge>
                    </CardTitle>
                  </CardHeader>
                        ...
                        <Card key={lead.id} className="p-3 cursor-pointer hover:shadow-md transition-shadow">
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              ...
                              <span className={`text-xs font-semibold ${getScoreColor(lead.score)}`}>{lead.score}</span>
                            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { stage: "Initial Contact", count: 30, percentage: 100 },

...
import { Search, Building2, TrendingUp, Users, Clock, ChevronDown, Heart, Star } from "lucide-react"
...
export default function HomePage() {
    ...
    ForLease: [
      {
        ...
        image: "/placeholder.svg?height=200&width=300&text=Office+Building",
      },
      {
        id: 2,
        type: "Coworking",
    ...
    ForSale: [
      {
        ...
        size: "19,000 SF",
        image: "/placeholder.svg?height=200&width=300&text=Office+For+Sale",
      },
      {
        id: 6,
        type: "Industrial",
    ...
    Auctions: [
      {
        ...
        size: "125,700 SF",
        image: "/placeholder.svg?height=200&width=300&text=Auction+Property",
      },
    ],
  }
  ...
  // Popular cities
  const popularCities = [
    { name: "New York City", image: "/placeholder.svg?height=150&width=200&text=NYC" },
    { name: "London", image: "/placeholder.svg?height=150&width=200&text=London" },
    { name: "Paris", image: "/placeholder.svg?height=150&width=200&text=Paris" },
    { name: "Los Angeles", image: "/placeholder.svg?height=150&width=200&text=LA" },
    { name: "Chicago", image: "/placeholder.svg?height=150&width=200&text=Chicago" },
    { name: "Miami", image: "/placeholder.svg?height=150&width=200&text=Miami" },
  ]
  ...
  const educationalArticles = [
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=200&width=300&text=Investment",
    },
  ]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-gradient-to-r from-blue-600/90 to-blue-800/90 text-white py-16 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/placeholder.svg?height=600&width=1200&text=City+Skyline"
            alt="City skyline"
            fill
        ...
        <div className="relative z-10">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">The World's #1 Commercial Real Estate Marketplace</h1>
                  ...
                  {propertyTypes.map((type) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        router.push(`/properties?propertyType=${type.id}&name=${type.name}`)
                      }}
                      className={`flex-shrink-0 flex flex-col items-center p-3 rounded-lg transition-colors ${
                        selectedPropertyType === type.id.toString() ? "bg-blue-100 text-blue-600" : "hover:bg-gray-100"
                      }`}
                    >
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <p className="text-lg text-gray-600 mb-8">
            For over 30 years, LoopNet has been the trusted brand for Commercial Real Estate
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <div className="text-4xl font-bold text-blue-600 mb-2">$109B+</div>
        ...
        <div className="container mx-auto px-4">
          ...
          <Tabs value={trendingTab} onValueChange={setTrendingTab}>
            <TabsList className="grid w-full grid-cols-3 max-w-md">
              ...
              <TabsTrigger value="Auctions">For Auctions</TabsTrigger>
            </TabsList>
                  ...
                  {properties.map((property) => (
                    <Card key={property.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                      <div className="relative">
                        ...
                        />
                        <Badge className="absolute top-2 left-2 bg-blue-600">{property.type}</Badge>
                      ...
                      <CardContent className="p-4">
                        <div className="space-y-2">
                          <div className="font-semibold text-blue-600">{property.price}</div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <p className="text-gray-600">Discover our best investment opportunities</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-4">Discover Your Next Investment at Auction</h2>
              <p className="text-lg mb-6 opacity-90">
                Identify and bid on quality assets through our transparent and competitive platform—all online. Join the
                investors worldwide who have partnered with us to successfully transact 11,000+ properties.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {popularCities.map((city, index) => (
              <Link key={index} href={`/search/${city.name.toLowerCase().replace(" ", "-")}`}>
                <div className="text-center group cursor-pointer">
                  ...
                  <h3 className="font-medium text-gray-900 group-hover:text-blue-600">{city.name}</h3>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-3xl font-bold">Commercial Real Estate Explained</h2>
            <Link href="/cre-explained" className="text-blue-600 hover:underline">
              See More
            </Link>
          </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4">LoopNet Listings Lease or Sell 14% Faster*</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="text-center">
              ...
              <p className="opacity-90">96% of the Fortune 1000 search on LoopNet</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="opacity-90">Stunning photography, videos and drone shots</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="opacity-90">Find a tenant or buyer, faster than before</p>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm opacity-75 mt-4">
              *Based on internal analysis comparing properties advertised on LoopNet to properties listed only on
              CoStar.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {[
              {
                question: "Is LoopNet Available for International Property Searches?",
                answer:
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-4">
                The leading commercial real estate marketplace connecting buyers, sellers, and industry professionals.
              </p>
            </div>

      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <DialogTitle className="text-2xl font-bold">{currentPlans.title}</DialogTitle>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {currentPlans.plans.map((plan, index) => (
            <div
              key={index}
              className={`relative border rounded-lg p-6 ${plan.popular ? "ring-2 ring-purple-600 scale-105" : ""}`}
            >
              {plan.popular && (
              ...
              <div className="text-center mb-6">
                ...
                {plan.trial && <p className="text-sm text-green-600 mt-1">{plan.trial}</p>}
              </div>
              ...
              {plan.limitations && (
                <div className="mb-6">
                  <h4 className="font-semibold text-gray-600 mb-2 text-sm">Limitations</h4>
              ...
              >
                {isLoading ? "Chargement..." : plan.price === 0 ? "Plan Actuel" : "Choisir ce Plan"}
              </Button>
            </div>
          ))}
        </div>

...
export function AccessRestriction({ action, children, fallback, showUpgradePrompt = true }: AccessRestrictionProps) {
  ...
  const upgradeLevel = requiresUpgrade(action as any)
    ...
    <Card className="border-dashed">
      ...
      <CardContent className="text-center space-y-4">
        ...
        <div className="space-y-2">
          <Button className="w-full">Passer au {upgradeLevel === "simple" ? "compte gratuit" : upgradeLevel}</Button>

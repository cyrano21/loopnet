...
function CreateCommissionForm({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // S'assurer que les champs optionnels sont correctement typés
    const submissionData: CreateCommissionData = {
      ...formData,
      salePrice: formData.salePrice || undefined,
      leaseAmount: formData.leaseAmount || undefined,
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                setFormData((prev) => ({
                  ...prev,
                  leaseAmount: Number(e.target.value) || 0,
                }))
              }
            />
          </div>
          <div>
            ...
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                setFormData((prev) => ({
                  ...prev,
                  leaseTerm: Number(e.target.value) || 0,
                }))
              }
            />
          </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
              setFormData((prev) => ({
                ...prev,
                agentSplit: Number(e.target.value) || 0,
              }))
            }
          />
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Select
            ...
            onValueChange={(
              value: "pending" | "negotiating" | "completed" | "cancelled",
            ) => {
              setFormData((prev) => ({
                ...prev,
                status: value as
